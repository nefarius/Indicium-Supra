...
class Build : NukeBuild
{
    ...
    Target Restore => _ => _
            ...
            .Executes(() =>
            {
                ...
                MSBuild(s => DefaultMSBuildRestore.SetTargetPlatform(MSBuildTargetPlatform.Win32));
            });
    ...
    Target Compile => _ => _
            ...
            .Executes(() =>
            {
                ...
                MSBuild(s => DefaultMSBuildCompile.SetTargetPlatform(MSBuildTargetPlatform.Win32));
            });
}
