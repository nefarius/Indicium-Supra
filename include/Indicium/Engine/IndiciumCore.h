...
extern "C" {
    ...
    typedef enum _INDICIUM_ERRORS
    {
        ...
        INDICIUM_ERROR_INVALID_D3D9_CALLBACKS_SIZE = 0xE0000002,
        INDICIUM_ERROR_INVALID_D3D10_CALLBACKS_SIZE = 0xE0000003,
        INDICIUM_ERROR_INVALID_D3D11_CALLBACKS_SIZE = 0xE0000004,
        INDICIUM_ERROR_INVALID_D3D12_CALLBACKS_SIZE = 0xE0000005,
        INDICIUM_ERROR_CREATE_THREAD_FAILED = 0xE0000006
    } INDICIUM_ERROR;
